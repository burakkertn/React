...
const Horizontalchart = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const url = 'https://localhost:44317/api/Doviz/eur';
      ...
      try {
        ...
        const usdData = apiData.map(item => item.eur);
        ...
        // Örnek olarak:
        const lineUrl = 'https://localhost:44317/api/Doviz/eur';
        ...
        const lineDataPoints = lineApiData.map(item => item.eur);
